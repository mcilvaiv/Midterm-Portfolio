...
> For the following vizulizations, I created a data frame with information about my closest friends. I wanted to practice creating my own data and work with both numerical, logical, and string data types.
