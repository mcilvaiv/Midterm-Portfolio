...
[Suoer Bowl Ad Project](https://jbedi10.github.io/Project-Proposal/costanalysis.html)
...
> In the grpah below, I created a similar graoh to the one above. Instead of using ggplot, I used highcharter to create a more interactve plot that has a nicer look to it. 
...
hc <- total3 %>% 
  ...
  hc
```
[Link to Interactive Cost Plot](https://rstudio.gvsu.edu/s/05d2adfe70ef5f2d7a1c3/session/viewhtml1350637e52c5df/index.html)
