...
> Since I have a lot of work in SAS, I am very familiar with the Iris data set. I wanted to create histograms of the 3 types od Iris plants. I have some something similar in SAS and wanted to extende upon those in R. Using facetwrap() I was able to display all 3 histograms next to each other in a visually astethic way.
```{r begin}
